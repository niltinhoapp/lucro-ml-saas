        ...
        {itens.length === 0 ? (
          ...
          <div className="list">
            {itens.map((s) => {
              ...
              const lucroBest =
                best === "FULL" ? s.resultado.full.lucro : s.resultado.flex.lucro;
              const margemBest =
                best === "FULL" ? s.resultado.full.margem : s.resultado.flex.margem;
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <div className="meta">
                      {dataBR(s.data)} • {s.unidades} un. • Melhor: <b>{best}</b>
                    </div>
                  </div>
                  ...
                  <div className="right">
                    <div className="pills">
                      ...
                      <span
                        className={`pill ${
                          margemBest >= 12 ? "good" : margemBest >= 0 ? "warn" : "bad"
                        }`}
                      >
                        {margemBest.toFixed(2)}%
                      </span>
                    </div>

                    <div className="small">Abrir</div>
                  </div>
                </div>
              );
            })}
