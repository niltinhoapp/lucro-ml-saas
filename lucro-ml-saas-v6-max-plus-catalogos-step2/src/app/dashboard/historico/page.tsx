...
export default function HistoricoPage() {
  ...
  return (
    <div className="page-wrap historico-page">
      ...
      <ProUpgradeButton
        title="Assine o PRO e mantenha histórico completo da operação"
        subtitle="Acompanhe simulações, compare cenários e evolua sua tomada de decisão com consistência."
      />
